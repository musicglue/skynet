...
execute "download-skynet" do
  command %Q{
    go get github.com/kballard/go-shellquote && go get github.com/sbinet/liner && go get github.com/musicglue/skynet
  }

  not_if do
    File.exists?("/opt/local/gopath/src/github.com/musicglue/skynet")
  end
end
...
execute "update-skynet" do
  cwd '/opt/local/gopath/src/github.com/musicglue/skynet'
...
execute "install-sky" do
  cwd '/opt/local/gopath/src/github.com/musicglue/skynet/cmd/sky'
